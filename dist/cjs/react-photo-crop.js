...
class CropHandler {
  ...
  getDataURL() {
    var quality = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0.85;
    var id = 'rpc-img';
    var imgOriginal = document.getElementById(id);
    if (!imgOriginal) throw Error("Could not find any image with id ".concat(id, "..."));
...
function useRPC() {
  return {
    getDataURL: function getDataURL() {
      var q = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0.85;
      return cropHandler.getDataURL(q);
    }
  };
}
